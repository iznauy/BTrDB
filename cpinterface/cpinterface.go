...
func ServeCPNP(q *btrdb2.Quasar, ntype string, laddr string) *CPInterface {
	rv := &CPInterface{}
	go func() {
...
func (c *CPInterface) dispatchCommands(q *btrdb2.Quasar, conn net.Conn) {
